import { PokemonRef, PokemonTypeRef } from "@context/game";
import type {
	IPokemonMetadataSource,
	PokemonMetadata,
	PokemonTraits,
...
export class PrismaPokemonMetadataSourceAdapter
	implements IPokemonMetadataSource
{
