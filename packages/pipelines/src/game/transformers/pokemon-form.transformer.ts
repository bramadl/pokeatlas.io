...
// function resolveSortGroup(
// 	form: Pick<TransformedPokemonForm, "formCategory">,
// ): number {
// 	return form.formCategory === "ALTERNATE_FORM" ? 1 : 0;
// }
...
// 				sortGroup: resolveSortGroup({ formCategory }),
// 				speciesId: pokemonId,
...
// 						formPriority: resolveFormPriority({
// 							formCategory: baseForm.formCategory,
// 							isCostume,
// 							isDefaultForm: false,
// 							isFemale: true,
// 							isTemporaryEvolution: false,
