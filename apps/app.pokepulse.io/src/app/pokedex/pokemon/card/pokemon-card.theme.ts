...
export interface PokemonCardTheme {
	badgeBg: string;
	badgeBorder: string;
	badgeText: string;
	cardBg: string;
...
export const POKEMON_THEME_MAP: Record<PokemonType, PokemonCardTheme> = {
	bug: {
		badgeBg: "bg-lime-100",
	...
	dark: {
		...
		cardBg: "from-zinc-600",
		cardBgOffset: "to-zinc-300",
		hoverBg: "group-hover:from-zinc-400",
	},
	...
	normal: {
		...
		cardBg: "from-neutral-400",
		cardBgOffset: "to-neutral-100",
		hoverBg: "group-hover:from-neutral-200",
	},
