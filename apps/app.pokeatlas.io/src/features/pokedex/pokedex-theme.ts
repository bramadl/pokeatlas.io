...
export const TYPE_THEME = {
	...
	dark: {
		...
		hoverBg: "from-zinc-200",
		tintedBorder: "hover:border-zinc-300/50",
		trackedBg: "from-zinc-400",
	...
	dragon: {
		...
		gradient: "from-mauve-100",
		hoverBg: "from-mauve-100",
		tintedBorder: "hover:border-mauve-300/50",
		trackedBg: "from-mauve-400",
		trackedBorder: "border-mauve-300",
		trackedRing: "ring-mauve-300/25",
	},
	electric: {
	...
	normal: {
		...
		badgeBorder: "border-olive-400",
		badgeText: "text-olive-700",
		gradient: "from-olive-100",
		hoverBg: "from-olive-200",
		tintedBorder: "hover:border-olive-300/50",
		trackedBg: "from-olive-400",
		trackedBorder: "border-olive-300",
		trackedRing: "ring-olive-300/50",
	},
	poison: {
		badgeBg: "bg-pink-100",
